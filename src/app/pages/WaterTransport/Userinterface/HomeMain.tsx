        ...
        <div className="container mt-4 flex-grow-1">
          ...
          >
            ...
            >
              ...
              <h5
                style={{ fontSize: "15px", color: "#555", fontStyle: "italic" }}
              >
                Book the Waves, Embrace the Journey.
              </h5>
            </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        ...
                        {sourceWeather ? (
                          <>
                            <p>
                              Temperature: {getSourceTempInCelsius?.toFixed(2)}
                              °C
                            </p>
                            <p>
                      ...
                      <div className="col-md-6">
                        ...
                        {destinationWeather ? (
                          <>
                            ...
                            <p>
                              Wind Speed: {destinationWeather.wind.speed} m/s
                            </p>
